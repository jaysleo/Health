	...
	<view class="content">
		...
		<!-- <view class="formBox">
			<u-cell-group :border="false">
				...
				<u-cell-item title="生理指标及异常指标检测" label="身高、体重、血糖、血压、Homa等" :border-bottom="false" @click="toH5('https://api.ifufan.com/yxb/blj/home.html?random=0.44186152806592305&uid=')" v-if="sjkids == '0e12' || sjkids == '196a'">
