<template>
	<view class="content">
		...
		<u-form label-width="300" label-align="right" :label-style="{ paddingRight: '20px' }">
			...
			<u-form-item label="手术时间">
				<text @click="operationTimeModal = true" v-if="form.operationTime">{{ form.operationTime }}</text>
				<text @click="operationTimeModal = true" v-else style="color: #bfbfbf;">请选择</text>
			</u-form-item>
		...
		<u-calendar v-model="operationTimeModal" mode="date" @change="operationTimeChange"></u-calendar>
...
export default {
	...
	methods: {
		...
		operationTimeChange(e) {
			this.form.operationTime = e.result;
		},
