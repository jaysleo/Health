<template>
	<view class="content">
		...
		<!-- <view class="tips">
			疾病严重程度为：
			<text style="" class="danger">评估中</text>
		</view> -->
		<view class="tips">
			姓名：
			<text style="" class="blue">{{ userInfo.isYxb == 2 ? userInfo.suffererName : userInfo.name }}</text>
		</view>
		<view class="tips">
			身份证号：
			<text style="" class="blue">{{ userInfo.isYxb == 2 ? userInfo.suffererIdcard : userInfo.idcard }}</text>
		</view>
		<view class="tips">
			手机号：
			<text style="" class="blue">{{ userInfo.phone }}</text>
		</view>
		<view class="tips" v-if="userInfo.isYxb">
			是否是银屑病患者：
			<text style="" class="danger" v-if="userInfo.isYxb == '1'">是</text>
			<text style="" class="blue" v-if="userInfo.isYxb == '0'">否</text>
		</view>
		<view class="tips" v-if="userInfo.isYxb == '1'">
			银屑病病程：
		...
		<!-- <view class="u-m-t-80"><u-button type="primary" block @click="toHome">阅读完毕，进入银屑病管理中心</u-button></view> -->
