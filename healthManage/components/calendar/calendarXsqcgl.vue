...
export default {
	...
	methods: {
		...
		addYaoLog() {
			let url = 'https://api.ifufan.com/vteyongyao/?random=' + Math.random() + '&uid=' + uni.getStorageSync('phone') + '&currentDate=' + this.today() + '#/add/';
			uni.navigateTo({
		...
		editYao(recordId) {
			let url = 'https://api.ifufan.com/vteyongyao/?random=' + Math.random() + '&uid=' + uni.getStorageSync('phone') ;
			uni.navigateTo({
				url: '/pages/h5/h5?url=' + encodeURIComponent(JSON.stringify(url))
			});
		},
		...
		dayChange(e) {
			if (e.info) {
				...
				let url = 'https://api.ifufan.com/vteyongyao/?random=' + Math.random() + '&uid=' + uni.getStorageSync('phone') + '&currentDate=' + e.fullDate + '#/add/';
				uni.navigateTo({
					url: '/pages/h5/h5?url=' + encodeURIComponent(JSON.stringify(url))
				});
			}
