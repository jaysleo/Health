<template>
	<view class="zzx-calendar">
		<view class="calendar-heander">
			...
			<view class="u-flex u-row-between u-p-10" style="color: #bfbfbf;" v-if="sjkids == '0e12'">
				<view class="u-m-r-5">
					<image src="../../static/images/druged.png" mode="" style="width: 30upx;height: 30upx;"></image>
					已用药
				</view>
				<view class="u-m-r-5">
					<image src="../../static/images/undrug.png" mode="" style="width: 30upx;height: 30upx;"></image>
					待用药
				</view>
				<view class="u-m-r-5">
					<image src="../../static/images/skined.png" mode="" style="width: 30upx;height: 30upx;"></image>
					皮肤清除
				</view>
				<view class="u-m-r-5">
					<image src="../../static/images/unskin.png" mode="" style="width: 30upx;height: 30upx;"></image>
					皮肤复发
				</view>
			</view>
		</view>
		...
		<view class="calendar-content">
						...
						<template v-if="sitem === current">
							...
							>
								...
								<view class="dot-show" v-if="item.info" :style="dotStyle">
									<image src="../../static/images/druged.png" mode="" v-if="item.info.type1" style="width: 40upx;height: 40upx;"></image>
									<image src="../../static/images/undrug.png" mode="" v-if="item.info.type2" style="width: 40upx;height: 40upx;"></image>
									<image src="../../static/images/skined.png" mode="" v-if="item.info.type3" style="width: 40upx;height: 40upx;"></image>
									<image src="../../static/images/unskin.png" mode="" v-if="item.info.type4" style="width: 40upx;height: 40upx;"></image>
									<image src="../../static/images/child.png" mode="" v-if="item.info.type5" style="width: 40upx;height: 40upx;"></image>
								</view>
							</view>
						</template>
						<template v-else>
			...
			<view class="mode-change" @click="changeMode"><view :class="weekMode ? 'mode-arrow-bottom' : 'mode-arrow-top'"></view></view>
		</view>
	</view>
</template>
...
.zzx-calendar {
	...
	.mode-change {
		...
		.mode-arrow-top {
			...
			border-bottom: 20upx solid #ff6633;
		}
		.mode-arrow-bottom {
			width: 0;
			height: 0;
